...
$onlyClientPerms[managechannels;J'ai besoin de la permission "Manage Channels"]
$onlyPerms[managechannels;J'ai besoin de la permission "Manage Channels"]
...
$wait[2s]
$sendMessage[$interactionUpdate[;{newEmbed: {title:Réinitialisation du salon...}{description:Réinitialisation du salon <#$channelID>, veuillez patienter.}{color:Green}};{actionRow: {button:Yes:success:nukeyes:true}{button:No:danger:nukeno:true}};;everyone;false]]`
},{
    name: "nukeno",
    type: "interaction",
    prototype: "button",
    code: `$interactionUpdate[;{newEmbed: {title:Annulation de l'action}{description:L'action a été annulée.}{color:Red}};{actionRow: {button:Yes:success:nukeyes:true}{button:No:danger:nukeno:true}};;everyone;false]`
}]